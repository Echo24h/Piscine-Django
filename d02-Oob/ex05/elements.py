...
class Link(Elem):
    def __init__(self, content=None, attr: dict = {}):
        super().__init__(tag='link', attr=attr, content=content, tag_type='simple')


class Script(Elem):
    def __init__(self, content=None, attr: dict = {}):
        super().__init__(tag='script', attr=attr, content=content, tag_type='double')
...
class A(Elem):
    def __init__(self, content=None, attr: dict = {}):
        super().__init__(tag='a', attr=attr, content=content, tag_type='double')
